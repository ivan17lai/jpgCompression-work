...
# --- Execution ---
input_image_path = 'file/girl.bmp'
...
if final_bitstream is not None:
    print("\n--- Generated Bitstream (first 500 bits) ---")
    print(final_bitstream[:500] + "...")
    print("--- End of Bitstream Snippet ---")

    # Optional: Save the bitstream to a file
    # try:
    #     with open("output_bitstream.txt", "w") as f:
    #         f.write(final_bitstream)
    #     print("Full bitstream saved to output_bitstream.txt")
    # except Exception as e:
    #     print(f"Error saving bitstream to file: {e}")
